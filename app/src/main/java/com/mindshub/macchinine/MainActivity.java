...
public class MainActivity extends GameActivity {
    ...
    private native int initBluetooth();
    ...
    static {
        ...
        // and you use libc++_shared.so, you must load the shared library before any
        // other
    ...
    private void hideSystemUI() {
        ...
        // This will put the game behind any cutouts and waterfalls on devices which
        // have
        ...
        // From API 30 onwards, this is the recommended way to hide the system UI,
        // rather than
        ...
        Log.e("TAG", "hide system ui completed");
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        hideSystemUI();
        // You can set IME fields here or in native code using
        // GameActivity_setImeEditorInfoFields.
